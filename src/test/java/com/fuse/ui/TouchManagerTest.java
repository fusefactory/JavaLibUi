 ...
 */
public class TouchManagerTest extends TestCase
{
   ...
   */
  public TouchManagerTest( String testName )
  {
      super( testName );
  }
  ...
  {
      return new TestSuite( TouchManagerTest.class );
  }
